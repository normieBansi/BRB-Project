...
\begin{enumerate}
    ...
    \item anomaly and classification pipeline using Isolation Forest and Random Forest,
    \item controlled traffic generation for testing using scenario scripts and TRex.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Random Forest classifies known scenario classes.
...
\begin{enumerate}
    ...
    \item train Random Forest on labeled scenario dataset,
...
\begin{enumerate}
    ...
    \item execute TRex stress profiles,
...
\begin{enumerate}
    ...
    \item traffic from scripted tests and TRex profiles.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item classification quality for labeled attack classes.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item supervised model helps classify known scenario types for faster triage.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item classification quality is strongly tied to label quality,
...
\begin{enumerate}
    ...
    \item anomaly and classification model scripts/artifacts,
